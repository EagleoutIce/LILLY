...
\input{Lilly_Files/Data/POIs/_LILLY_BOXES_DEFAULT}

%\input{Lilly_Files/Data/POIs/_LILLY_BOXES_DEFAULT} % May the ones below do not cover all boxes - default will happily provide them
...
\LILLYcommand{\DEFINITIONS}[1]{%
    %%\LILLYxBOXESxaddListElementxAD[DEFINITIONS]{DEFS}{\thetcbcounter}{#1}{}
...
\else
    \LILLYcommand{\inputUB}[3]{}
    \LILLYcommand{\inputUBS}[3]{}
\fi
