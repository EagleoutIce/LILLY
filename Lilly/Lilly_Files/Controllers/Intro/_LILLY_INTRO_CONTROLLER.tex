...
\input{Lilly_Files/Data/Semster/\LILLY@Semster/Definitions/GENERAL.tex}
...
\ifx\LILLY@Typ\LILLY@Typ@Mitschrieb
    ...
    \input{Lilly_Files/Data/Semster/\LILLY@Semster/Definitions/\LILLY@Vorlesung} %%Konstanten etc.

    \input{Lilly_Files/Data/Semster/\LILLY@Semster/TitlepageProvider.tex}
