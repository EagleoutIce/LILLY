...
\immediate\write18{cd Lilly/Lilly_Files/Data/Semster/2/Graphics && make -B all}
\AtBeginDocument{
\clearpage\begin{titlepage} 
    ...
    \par\vspace*{9em}\par
    \includegraphics[height=16em]{Lilly_Files/Data/Semster/2/Graphics/titleimage_\LILLY@Vorlesung.pdf}
    \par\vspace*{1em}\par
...
\clearpage\begin{titlepage} 
    {\centering\par
    \par\vspace*{3em}\par
    {\tab[\LILLYxTITLExOffset] \raisebox{4.5em}{\parbox[0em]{0em}{\includegraphics[height=8em]{Lilly_Files/Data/Semster/2/Graphics/titleimage_\LILLY@Vorlesung.pdf}}\tab[-\LILLYxTITLExOffset]}}
    {\bfseries\usefont{T1}{qzc}{m}{it}\fontsize{32pt}{16pt}\selectfont\FULLTITLE\par}
    \vspace{1cm}
