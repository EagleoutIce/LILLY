...
\begin{tikzpicture}
  ...
  \draw[ultra thick] (-1.9,1.75) -- ++ (1.25,0) -- ++(1.5,.6) -- ++(1.25,0);
  \draw[ultra thick] (-1.9,2.35) -- ++ (1.25,0) -- ++(1.5,-.6) -- ++(1.25,0);
\end{tikzpicture}}

\makeatletter
\pgfdeclareradialshading[tikz@ball]{cloud}{\pgfpoint{-.275cm}{.4cm}}{%
  color(0cm)=(tikz@ball!75!white);
  color(.1cm)=(tikz@ball!85!white);
  color(.2cm)=(tikz@ball!95!white);
  color(.7cm)=(tikz@ball!89!black);
...
\tikzset{my cloud/.style={cloud, draw, aspect=2,cloud color={gray!5!white}}}