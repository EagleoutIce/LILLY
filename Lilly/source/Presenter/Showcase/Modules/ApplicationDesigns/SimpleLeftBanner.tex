...
\def\@applications@StartBannerBlock#1#2{\begingroup\color{\lilly@applications@contrast@color}\Large%
    \leavevmode\vskip1.5em\hbox{}\hskip1em\relax\parbox{1.5em}{\huge#1\strut}~\MakeUppercase{#2}\(\;\)\@applications@raisedrule[0.25\baselineskip]{1pt}\hskip3.55pt\smallskip\endgroup
}
% #1 Symbol
% #2 Text
\def\@applications@StartBlock#1#2{\begingroup\color{\lilly@applications@primary@color!75!black}\Large%
    \leavevmode\newline\hbox{}\hskip1em\relax\parbox{1.5em}{#1\strut}~\MakeUppercase{#2}\(\;\)\@applications@raisedrule[0.25\baselineskip]{1.25pt}\smallskip\endgroup
    %
}
% #1 progress
