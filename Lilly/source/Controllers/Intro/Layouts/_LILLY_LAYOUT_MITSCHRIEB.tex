...
\LILLYcommand{\LILLYxLayoutxRestore}{ % 
    ...
    \else%% \LILLYxFACULTYxCOLOR
        \lofoot{\scriptsize{\tikz[baseline=1.215ex]{\filldraw[LightGray,draw, rounded corners=1pt] (0,0) -- ++(1.45,0) -- ++(0.25,0.25) -- ++ (-0.25,0.25) -- ++(-1.45,0) -- cycle (0.75,0.25) node[minimum height=\baselineskip, inner sep=1pt,\LILLYxLINKSxMainColor]{\silentHmark[Kapitel]{eagleTOC}[\LILLYxLINKSxMainColor]};} \leftmark}}
        %\fi
        \lohead{\AUTHOR}
        \cofoot{}
        \rohead{\heute}
