...
\input{\LILLYxPATHxDATA/Semester/\LILLYxSemester/Definitions/GENERAL.tex}
\fi
...
\ifx\LILLY@Typ\LILLY@Typ@Mitschrieb
    ...
    \input{\LILLYxPATHxCONTROLLERS/Intro/Layouts/_LILLY_LAYOUT_MITSCHRIEB}
\else\ifx\LILLY@Typ\LILLY@Typ@Uebungsblatt
    
    \input{\LILLYxPATHxDATA/Semester/\LILLYxSemester/Definitions/\LILLYxVorlesung} %%Konstanten etc.

    \input{\LILLYxPATHxCONTROLLERS/Intro/Layouts/_LILLY_LAYOUT_UEBUNGSBLATT} %% Einleitung Übungsblatt

\else\ifx\LILLY@Typ\LILLY@Typ@Dokumentation

%% Wir setzen keine Definitionen und definieren ein Standard Layout

\input{\LILLYxPATHxCONTROLLERS/Intro/Layouts/_LILLY_LAYOUT_DOKUMENTATION}
...
\input{\LILLYxPATHxCONTROLLERS/Intro/Layouts/_LILLY_LAYOUT_ZUSAMMENFASSUNG}
