    ...
    \clearpage\begin{titlepage} 
        ...
        \begin{tikzpicture}
            ...
            \begin{scope}[every node/.style={color=LightGray}]
                ...
                \node[above left] at(\paperwidth,0.02) {\begingroup\hypersetup{urlcolor=MudWhite}\href{https://github.com/EagleoutIce/LILLY}{\usefont{U}{Konanur}{xl}{n}LILLY}\hypersetup{urlcolor=\LILLYxColorxLINKSxUrlColor}\endgroup};
