...
\clearpage\begin{titlepage} 
    {\centering\par
    \par\vspace*{3em}\par
    {\tab[\LILLYxTITLExOffset] \raisebox{4.5em}{\parbox[0em]{0em}{\includegraphics[height=8em]{\LILLYxPATHxDATA/Semester/1/Graphics/titleimage\LILLY@Vorlesung.pdf}}\tab[-\LILLYxTITLExOffset]}}
    {\bfseries\usefont{T1}{qzc}{m}{it}\fontsize{32pt}{16pt}\selectfont\FULLTITLE\par}
    \vspace{1cm}
