...
\clearpage\begin{titlepage}
    ...
    \footnotesize{Und da waren sie wieder und tanzten im Mondlicht,\\
        ...
        Und nun schlugen ihre Herzen wie die Füße im Takt\smallskip\\
        - ein Glück, dass das Eis gehalten hat -\\
    }
...
\clearpage\begin{titlepage}
    {\centering\par
        ...
        \endgroup\par
        \par\vspace*{2em}\par
    {\tab[\LILLYxColorxTITLExOffset] \raisebox{4.5em}{\parbox[0em]{0em}{\includegraphics[height=8em]{\LILLYxPATHxDATA/Semester/2/Graphics/titleimage\LILLYxVorlesung.pdf}}\tab[-\LILLYxColorxTITLExOffset]}}
    {\bfseries\usefont{T1}{qzc}{m}{it}\fontsize{32pt}{16pt}\selectfont\FULLTITLE\par}
    \vspace{1.15cm}
