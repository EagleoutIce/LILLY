...
Alle Grafiken wurden vom Autor mithilfe von \LaTeX{} und \TikZ{} erstellt und basieren zum Teil auf denen des Vorlesungsmaterials. Das Layout wurde Florian Sihlers' Lilly-Framework realisiert (\url{https://github.com/EagleoutIce/LILLY}).{}\hfill {\tiny Florian Sihler}\\\begin{center}
...
\providecommand\LILLYxTITLExOffset{10.3cm}
