...
\begin{tikzternal}
    ...
    \draw (3) ++ (1.25,-0.25) node[right] {\begin{minipage}{0.5\textwidth}
        ...
        Kann von \jmark[NFA]{jmp:NFA} und \jmark[DFA]{jmp:DFA} realisiert werden.
    \end{minipage}};
...
\LILLYcommand{\LILLYxGRAPHICSxSHOW}{\GRAPHICSxChomskyxHierarchie} %% new pattern maybe apply to all?
