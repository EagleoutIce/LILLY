...
lines before break=4, before skip=0pt, boxrule = 0mm, toprule=.5mm, %
bottomtitle=.5mm,bottomrule=1.2mm, after skip=0pt, enlarge top by=.2\baselineskip, enlarge bottom by=.2\baselineskip, sharp corners=south, breakable}}
...
title={\LILLYxDEFAULTxTYPESETxTITLE{#1}{#2}\ifx\LILLYxBOXxBeispielxLock\true\\\else\\\fi}%
}
}{%
...
title={\LILLYxDEFAULTxTYPESETxTITLE{#1}{#2}\ifx\LILLYxBOXxBemerkungxLock\true\\\else\\\fi} %
}
}{%
...
title={\LILLYxDEFAULTxTYPESETxTITLE{#1}{#2}\ifx\LILLYxBOXxSatzxLock\true\\\else\\\fi} %
}
}{%
...
title={\LILLYxDEFAULTxTYPESETxTITLE{#1}{#2}\ifx\LILLYxBOXxBeweisxLock\true\\\else\\\fi} %
}}{%
...
title={\LILLYxDEFAULTxTYPESETxTITLE{#1}{#2}\ifx\LILLYxBOXxLemmaxLock\true\\\else\\\fi} %
}}{%
...
title={\LILLYxDEFAULTxTYPESETxTITLE{#1}{#2}\ifx\LILLYxBOXxZusammenfassungxLock\true\\\else\\\fi} %
}
}{%
...
\DeclareTColorBox{LILLYxBOXxAufgabe}{O{} O{} O{}}{enforce breakable, %enforce breakable für: Mehr Seiten
    ...
    colback=white,colframe=black!50,boxrule=.2mm,
...
\DeclareTColorBox{LILLYxBOXxAufgabexPlain}{O{} O{} O{}}{enforce breakable, enhanced jigsaw, before skip=2mm,after skip=2mm, colback=white,colframe=black!50,boxrule=\z@,lines before break=4, fonttitle=\bfseries, #3,title={#2 \ifthenelse{\equal{#1}{}}{}{--~}#1}}