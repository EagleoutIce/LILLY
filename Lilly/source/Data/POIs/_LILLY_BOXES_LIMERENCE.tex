...
\makeatletter
\tcbset{LillyxBOXxDesignxLimerence/.style={enforce breakable, lines before break=3, enhanced jigsaw,sharp corners, boxrule=0pt, fonttitle={\bfseries}, coltitle={black}, attach title to upper, opacityfill=0.45, top=3pt, bottom=3pt, right=5pt, frame hidden,colback=LightGray!23!white,grow to right by=3pt,enlargepage flexible=\baselineskip,after title app={\hbox{}~\vspace*{-.85\baselineskip}\newline\unskip\widowpenalties=3 10000 10000 150}}}
