...
LillyxBOXxDesignxLimerence, #3, IfValueTF={#1}{title={$\vcenter{#2\ifthenelse{\equal{#1}{}}{}{--~}\parbox[t]{\linewidth-\widthof{#2}-1.75em}{#1}}\hfill\!\vcenter{\parbox[t]{\linewidth}{\textcolor{\LILLYxColorxZusammenfassung}{\large\faArchive}}}$\\}}{title={$\vcenter{#2\parbox{\linewidth-\widthof{#2}-1.75em}{}}\hfill\!\vcenter{\parbox[t]{\linewidth}{\textcolor{\LILLYxColorxZusammenfassung}{\large\faArchive}}}$}}, %
}
