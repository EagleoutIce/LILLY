...
\titlecontents{section}[5.5em]
{\hspace*{-1.25em}} {\contentslabel{3.2em}} {} {,\itshape\contentspage}
...
\AtBeginDocument{%
	...
	\addtocontents{POEM}{\protect\begin{multicols}{2}}
	% Two column \listofQUOTES
	\addtocontents{QUOTE}{\protect\begin{multicols}{2}}
}
\AtEndDocument{%
...
\list@poems@seentrue%
\list@quotes@seentrue%

\def\poemstoc{%
	{%
		\hypersetup{linkcolor=black}%
		\iflist@poems@seen% this would require some extensive trickery, therefore they're set/forced to true
		\OrnamentsUpper[][]{\poems@tocpoemsheader}\vspace*{-1\baselineskip}%
			\listofPOEMS\vspace*{-2\baselineskip}%
		\OrnamentsLower{}%
		\fi%
		\iflist@quotes@seen%
		\clearpage\OrnamentsUpper[][]{\poems@tocquotesheader}\vspace*{-1.5\baselineskip}%
...
\def\poems@title{Gedichtsammlung}
\def\poems@subtitle{Gedichte der Jahre $42$\,--\,$84$}

\def\poems@tocpoemsheader{Inhaltsverzeichnis}
\def\poems@tocquotesheader{Alle Zitate}
