...
\newcommand*\starchapter[1]{\defChapter*{#1}}
...
\makeatletter
\renewcommand\sectionlinesformat[4]{\phantomsection #4}
\renewcommand\sectionlinesformat[4]{\phantomsection{{\smaller #3} #4}}
...
{-3ex \@plus -.1ex \@minus -.4ex}{.5ex \@plus.2ex }
