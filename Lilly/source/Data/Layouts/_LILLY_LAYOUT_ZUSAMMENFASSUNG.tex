...
\addcontentsline{toc}{section}{Anhänge}\addcontentsline{TOPIC}{TOPICS}{Anhang}\appendixtrue%
...
\providecommand{\TOP}[3][top_default_jmpmrk]{%
    ...
    \ifnum\value{TOPICS}>0\addcontentsline{DEFS}{chapter}{#2}\fi\addcontentsline{toc}{section}{#2}%
