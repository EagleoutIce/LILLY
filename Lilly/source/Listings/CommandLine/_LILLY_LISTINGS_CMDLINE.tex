...
\lstinputlisting[language=BashOutput]{\jobname.txt}
...
\begingroup
\colorbox{MudWhite!93!black}{\lstinline[language=bash]{#1}}%
\endgroup
}
...
\begingroup
\lstinputlisting[language=bash, caption={Inhalt der Datei #1}]{#1}
\endgroup
\previewBash{bash #1}
}
