...
\lstdefinelanguage{lBash}{
    ...
    morekeywords = [3]{print,install,update,get,dump,config,tokentest,clean,help,file_compile,generate},
    morekeywords = [4]{lilly_compile.sh,sudo,lilly_jake,jake,java,ghci,ghc,grep,ls,cp,sort,find,man,tail,head,setfacl,getfacl,groups,ls,pdflatex,apt-get,texdoc,traceroute},
