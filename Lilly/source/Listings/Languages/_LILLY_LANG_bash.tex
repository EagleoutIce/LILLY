...
\lstdefinelanguage{lBash}{
    ...
    morekeywords = [4]{lilly_compile.sh,sudo,lilly_jake,jake,java,ghci,ghc,grep,ls,cp,sort,find,man,tail,head,setfacl,getfacl,groups,ls,pdflatex,apt-get,texdoc},
