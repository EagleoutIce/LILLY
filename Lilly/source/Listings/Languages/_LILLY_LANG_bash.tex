...
\lstdefinelanguage{lBash}{
    ...
    morekeywords = [4]{lilly_compile.sh,sudo,lilly_jake,jake,java,ghci,ghc,grep,ls,cp,sort,find,man,tail,head,setfacl,getfacl,groups,ls},
    morekeywords = [5]{GUI,REI,DEI},
    morekeywords = [6]{javafx:compile,javafx:run,-debug,-lilly-boxes:,-lilly-boxes+:,-lilly-path:,-file:,-jar,-lilly-author:,-l,-m,-p,-dir,-path:},
    morestring=[b]'
}
