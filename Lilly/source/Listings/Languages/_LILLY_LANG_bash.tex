...
\lstdefinelanguage{lBash}{
    ...
    morekeywords = [3]{print,install,dump,config,tokentest,help,file_compile},
    ...
    morekeywords = [5]{GUI},
    morekeywords = [6]{javafx:compile,javafx:run,-debug,-lilly-boxes:,-lilly-boxes+:,-lilly-path:,-file:,-jar,-lilly-author:,-l,-m,-p,-dir},
    morestring=[b]'
}
