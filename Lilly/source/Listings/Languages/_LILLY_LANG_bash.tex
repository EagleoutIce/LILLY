...
\lstdefinelanguage{lBash}{
    ...
    escapeinside={*}{*},
    morekeywords = {bash},
    morekeywords = [2]{mkdir,texhash,make,apt,>,<,cd,git,pdflatex,mvn,sh},
    morekeywords = [3]{print,install,update,get,dump,config,tokentest,clean,help,buildfile_compile,generate,curl,service,groupadd,usermod},
