...
\lstdefinelanguage{lBash}{
    ...
    morekeywords = [3]{print,install,get,dump,config,tokentest,clean,help,file_compile},
    ...
    morekeywords = [6]{javafx:compile,javafx:run,-debug,-lilly-boxes:,-lilly-boxes+:,-lilly-path:,-file:,-jar,-lilly-author:,-l,-m,-p,-dir,-path:,-shell-escape},
    morestring=[b]'
}
