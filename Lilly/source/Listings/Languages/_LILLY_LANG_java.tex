...
\newcommand{\@@JavaImport}[1]{import~\textit{#1};}
...
\lstdefinelanguage{lJava}{
    ...
    % {\\033\[}{{\lstkwtwo{\textbackslash 033[}}}5
    ...
    % moredelim=[is][\@@JavaImport]{import\ }{;}, % there shouldn't be any highlights in a line prefixed with import :D
