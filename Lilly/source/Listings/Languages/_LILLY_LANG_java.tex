...
\lstdefinelanguage{lJava}{
    ...
    escapeinside={!*}{*!},
    morecomment=[s]{/*}{*/},
    morekeywords = {String,System,Integer,var}, %% Damit ich nichts mehr machen muss:
