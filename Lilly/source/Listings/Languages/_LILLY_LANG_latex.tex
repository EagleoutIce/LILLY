...
\lstdefinelanguage{lLatex}{
    ...
    columns=[c]flexible,
    escapeinside={!*}{*!},
    morekeywords = [2]{Lilly,Jake,book,lipsum,geometry,LILLYxMATH,LILLYxGRAPHICS,LILLYxCOLOR,LILLYxBOXES,LISTxCompatColors,LILLYxCONTROLLERxBOX,LILLYxLISTINGS,LILLYxLISTINGSxADVANCED,LILLYxLIST,LILLYxFORMATxCONTROL,LISTxColors,\\LISTxCompatColors,\\LISTxColors,\\def,\\gdef,\\@nil,\\DeclareDocumentCommand,\\if,\\ifx,\\else,\\fi},
