...
\lstdefinestyle{Java}{
    ...
    morekeywords = [2]{Stream,List,Queue,ArrayList,SingleLinkedList,SortedList,SortedSet,Set,HashMap,Tree,HashSet},
    morekeywords = [3]{contains,toUpperCase,println,push,pop,sort,get,iterator,spliterator,add,matches},
    morekeywords = [4]{Files,Paths,Collectors,Collection,Iterable,Iterator,Object},
    morekeywords = [5]{filter,map,sorted,collect,toList,forEach,mapToInt,stream,sum},
}
