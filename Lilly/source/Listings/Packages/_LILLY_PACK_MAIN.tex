...
\pgfkeys{/lillyxLISTINGS/packages/MAIN/.is family,%
        ...
        numberstyle/.initial={\color{gray}\LILLYxLISTINGSxNUMxFONTSIZE\sffamily},%
        % Generic Configurations
        % breaklines/.initial={true},% Currently won't expand correctly
        % extendedchars/.initial={true},%
        prebreak/.initial={\raisebox{0.35\baselineskip}{\rotatebox{270}{\fontsize{6pt}{6pt}\selectfont$\curvearrowright$}}},%
        % core styles
        ...
        % Keywordstyles
        keywordstyle/.initial={\LILLYxCODExKEYWORDSTYLE\bfseries},%
        keywordstyle 2/.initial={\color{Azure}},%
        keywordstyle 3/.initial={\color{AppleGreen}},%
        keywordstyle 4/.initial={\color{DatmouthGreen}\bfseries},%
...
\lstdefinestyle{MAIN}{
    ...
    % texcsstyle      = *\lstPackget{keywordstyle},
    % texcsstyle      = *[2]\lstPackget{keywordstyle 2}, %%KW
    % texcsstyle      = *[3]\lstPackget{keywordstyle 3}, %% PARAM
    % texcsstyle      = *[4]\lstPackget{keywordstyle 4}, %% FILES
    % texcsstyle      = *[5]\lstPackget{keywordstyle 5}, %% SHELLPRE
    % texcsstyle      = *[6]\lstPackget{keywordstyle 6}, %% SHELLPRE
    otherkeywords   = {},
    alsoletter      = {@_},
