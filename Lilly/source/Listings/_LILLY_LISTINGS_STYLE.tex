...
\DeclareRobustCommand{\LILLYxwriteLst}[2][style=shell]{\tikz[baseline=-0.6ex]{\node[rectangle, minimum height=0.9\baselineskip, inner sep=1pt,draw, rounded corners=5pt,MudWhite, fill=MudWhite, centered]{\,\lstinline[#1]{#2}\,};}}

\input{\LILLYxPATHxLISTINGS/Languages/_LILLY_LANG_\LILLYxListingsxLang}



\DeclareRobustCommand{\java}[1]{\LILLYxwriteLst[style=bash,language=Java,morekeywords={System}]{#1}}
