...
\NewDocumentCommand{\ymark}{O{y} m O{0.15}}{\draw (\lillyxPlotxMinX,#2-\lillyxPlotxOffset)++(#3,0) -- ++(-2*#3,0) node [left] {\fontsize{\lillyxPlotxLabelSize}{\lillyxPlotxNumSize}\selectfont #1};}
