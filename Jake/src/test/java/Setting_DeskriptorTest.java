...
import static de.eagle.lillyjakeframework.util.enumerations.eSetting_Type.*;
...
class Setting_DeskriptorTest {
    ...
    void test_3_paramter_constructor(){
        Setting_Deskriptor<Integer> s = new Setting_Deskriptor<Integer>("TestDesk",
                "Testerklärung",
                IS_OPERATION);
    ...
    void test_4_paramter_constructor(){
        Setting_Deskriptor<Character> s = new Setting_Deskriptor<Character>("",
                "Sonnenschein",
                IS_OPERATION,
                true);
    ...
    void test_5_paramter_constructor(){
        Setting_Deskriptor<String> s = new Setting_Deskriptor<String>("Paul",
                "Rofll",
                IS_OPERATION,
                false,
                "StartwertMartlehrt");
