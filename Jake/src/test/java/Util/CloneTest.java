...
/**
 * Testet kopier funktionalität einiger Klassen - einfach weil PassByReference
 * nicht immer gewünscht ist hust hust
 */
@Tag("clone")
...
class CloneTest {
    ...
    Settings _generate_simple_settings() {
        ...
        testSets.put("Hallo",
                SettingDeskriptor.create("Hallo", "Hallo Welt Einstellung", eSetting_Type.IS_TEXT, false, "MAUUUUUUU"));
     ...
     */
    @Test
    @DisplayName("[Cloner] Teste Simple kopie von Einstellungen")
    void _test_Settings_clone() {
        Settings set = _generate_simple_settings();
        Settings clone = set.cloneSettings();
        Assertions.assertTrue(set.equals(clone),
                "Das geklonte Einstellungsobjekt stimmt nicht mit der Quelle überein!");
    }
