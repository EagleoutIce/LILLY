...
public class Setting_Deskriptor<T extends Serializable> implements Serializable {
    ...
    /**
     * Konstruiert den entsprechenden nicht verpflichtenden Text Deskriptor
     *
     * @param name  der (interne) Name der Einstellung
     * @param brief Eine kurze Beschreibung der Einstellung
     */
    public Setting_Deskriptor(String name, String brief) {
        this(name, brief, eSetting_Type.IS_TEXT, false, null);
    }

    /**
     * Konstruiert den entsprechenden nicht verpflichtenden Deskriptor
     *
     * @param name  der (interne) Name der Einstellung
     * @param brief Eine kurze Beschreibung der Einstellung
     ...
     * @throws MandatorySettingException Wenn eine verpflichtende Einstellung nicht gesetzt ist!
     */
    public T getValue() {
