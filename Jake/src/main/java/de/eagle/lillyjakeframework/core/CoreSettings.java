...
public class CoreSettings {
    ...
    private static SettingsTranslator translator;
    ...
    public static boolean init() {
        ...
        try {
            ...
            // Hier wurden schon einemal die für Buildrues wichtigen Einstellungen eingefügt:
    ...
    /**
     * Liefert eine Einstellung auf Basis eines mithilfe des {@link SettingsTranslator} übersetzen
     * Keys
     *
    ...
    public static String get(String key){
        init(); return settings.getValue(key);
    }

    public static boolean set(String key,String val){
        init(); return settings.set(key, val);
    }
