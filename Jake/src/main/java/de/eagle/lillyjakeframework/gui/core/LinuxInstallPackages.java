...
/**
 * @file LinuxInstallPackages.java
 * @author Florian Sihler
 * @version 1.0.0
 *
 * @since 2.0.0
 *
 * @brief Erlaubt das Installieren zusätzlicher Pakete auf Linux im GUI-Modus.
 */
...
public class LinuxInstallPackages extends JDialog {
    ...
    private JLabel toInstall;

    private String[] pkgs;

    public LinuxInstallPackages(String... packages) {
        setContentPane(contentPane);
        setModal(true);
        getRootPane().setDefaultButton(buttonOK);
        toInstall.setText("<html>" + String.join("<BR>  -   ", packages) + "</html>");
        pkgs = packages;
    ...
    public static void main(String[] args) {
        LinuxInstallPackages dialog = new LinuxInstallPackages(args);
        dialog.pack();
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel3.setBorder(BorderFactory.createTitledBorder("Installiere Pakete"));
        toInstall = new JLabel();
        toInstall.setText("Label");
        panel3.add(toInstall, new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST, com.intellij.uiDesigner.core.GridConstraints.FILL_NONE, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
