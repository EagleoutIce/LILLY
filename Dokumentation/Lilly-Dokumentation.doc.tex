...
\documentclass[Dokumentation,iall]{Lilly}%debug for more information as additional argment => TOOD: document :D: doesn't seem to work. check?
...
% %%% Listen für Versionen der entsprechenden Befehle
...
\DeclareDocumentCommand{\addcmd}{ O{1.0.0} m}{%
    \ifthenelse{\equal{#1}{\LILLYxVERSION}}{\iwriteNewCommands{\noexpand\pushList{lNewCommands}{\noexpand c#2}}}{}\index{#2`{\blankcmdidx{#2}\textsuperscript{\tiny\T{(v#1)}}}}\ignorespaces%
}
\DeclareDocumentCommand{\addenv}{ O{1.0.0} m}{%
    \ifthenelse{\equal{#1}{\LILLYxVERSION}}{\iwriteNewCommands{\noexpand\pushList{lNewCommands}{\noexpand e#2}}}{}\index{#2`{\blankenvidx{#2}\textsuperscript{\tiny\T{(v#1)}}}}\ignorespaces%
}
