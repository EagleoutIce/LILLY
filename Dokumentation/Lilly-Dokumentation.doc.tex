...
\documentclass[Dokumentation,kpfont]{Lilly}%debug for more information as additional argment => TOOD: document :D: doesn't seem to work. check?
...
% Make the persitence library (2.2.0)
%% FOR 2.1.0:
% Changelog
