...
\begin{center}
    \begin{tabular}{!{\VRule[1pt]}@{\hspace{1em}}l@{\hspace{1em}}|@{\hspace{1em}}c@{\hspace{1em}}!{\VRule[1pt]}}
        ...
        \blatex{:bs:overbar\{a\_1\} :bs:overbar\{a\_2\}} & \(\overbar{a_1}\overbar{a_2}\)\\\hline
        \blatex{:bs:overline\{a\_1\} :bs:overline\{a\_2\}} & \(\overline{a_1}\overline{a_2}\)\\
        \specialrule{1pt}{0pt}{0pt}
    \end{tabular}
\end{center}
%
...
\begin{center}
    \begin{tabular}{!{\VRule[1pt]}@{\hspace{1em}}l@{\hspace{1em}}|@{\hspace{1em}}c@{\hspace{1em}}!{\VRule[1pt]}}
        \specialrule{1pt}{0pt}{0pt}
        \blatex{:bs:sqrt[3]\{42\}} & \(\sqrt[3]{42}\)\\\hline
        \blatex{:bs:oldsqrt[3]\{42\}} & \(\oldsqrt[3]{42}\)\\
        \specialrule{1pt}{0pt}{0pt}
...
\begin{center}
    \begin{tabular}{!{\VRule[1pt]}@{\hspace{1em}}C{7cm}@{\hspace{1em}}|@{\hspace{1em}}C{2cm}@{\hspace{1em}}!{\VRule[1pt]}}
        \specialrule{1pt}{0pt}{0pt}
        \blatex{:bmath::bs:abs\{:bs:frac\{:bs:pi-x^2\}\}\{:bs:log 3x\}:emath:} & \(\displaystyle\abs{\frac{\pi - x^2}{\log 3x}}\)\\\hline
        \blatex{:bmath:|:bs:frac\{:bs:pi-x^2\}\{:bs:log 3x\}|:emath:} & \(\displaystyle|\frac{\pi - x^2}{\log 3x}|\)\\
        \specialrule{1pt}{0pt}{0pt}
    \end{tabular}\smallskip
\end{center}
%
