...
\chapter[Mathe \LILLYxBOXxVersion{\small 2.0.0}]{Mathe}
...
\begin{bemerkung}[Standalone-Math]
    Mit \LILLYxBOXxVersion{2.0.0} wurde die Mathe-Integration als eigenes Paket (\LILLYxNOTExLibrary{LILLYxMATH}) etabliert, welches sich auch eigenständig über \begin{latex}
