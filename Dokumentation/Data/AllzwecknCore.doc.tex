...
\presentCommand[2.1.0]{NewRecorder}[\manArg{ID}\manArg{Extension}]
Erstellt eine Datei mit dem entsprechenden Suffix \T{Extension} und bindet diese, sofern vorhanden, direkt ein. Weiter werden die Befehle: %
\def\ttlsx#1{\blankcmd{#1<ID>}}\typesetList[ttlsx]{write,iwrite,pwrite,pause,unpause,close,iclose}{} erstellt.
...
\presentCommand[2.1.0]{write<ID>}[\manArg{Data}\cmdlist\anothercmd[2.1.0]{iwrite<ID>}\manArg{Data}\cmdlist\anothercmd[2.1.0]{pwrite<ID>}\manArg{Data}]
