...
\hypertarget{LILLYxFONTS}Diese Definitionen werden über die Bibliothek \LILLYxNOTExLibrary{LILLYxFONTS} zur Verfügung gestellt. Sie werden mit \LILLYxBOXxVersion{2.1.0} automatisch mit dem Einbinden von \LILLYxNOTExLibrary{LILLYxUTIL} geladen. Es kann eine der folgenden Optionen dem Paket oder Lilly übergeben werden, um die Dokumentschriftart zu ändern: \T{garamond}, \T{crimson}, \T{lcrimson}, \T{kpfont}. Diese Dokumentation wurde durch folgenden Aufruf erzeugt:
\begin{latex*}
