...
\hypertarget{LILLYxTIMETABLES}Diese Definitionen werden über die Bibliothek \LILLYxNOTExLibrary{LILLYxPLILLYxTIMETABLESOEMS} zur Verfügung gestellt. Sie werden mit \LILLYxBOXxVersion{2.0.0} automatisch mit dem Einbinden von \LILLYxNOTExLibrary{LILLYxPRESENTER} geladen.
