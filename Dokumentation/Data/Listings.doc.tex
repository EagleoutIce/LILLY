...
\begin{center}
    \blankcmd{LILLYxPATHxLISTINGS} = \T{\LILLYxPATHxDATA}
\end{center}

\begin{bemerkung}[Standalone Listings]
    Mit \LILLYxBOXxVersion{2.0.0} wurde die Listings-Integration als eigenes Paket (\LILLYxNOTExLibrary{LILLYxLISTINGS}) etabliert, welches sich auch eigenständig über \begin{latex}
...
\presentCommand[2.0.0]{cmdshowcase}[\manArg{command}]
