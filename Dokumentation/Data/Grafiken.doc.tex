...
\end{fancydir}
\end{defaultlst}
Standardmäßig ist jedes Element ein Verzeichnis. Dateien werden durch \T{file}, wichtige Dateien durch \T{ifile} und wichtige Ordner durch \T{idir} markiert. % Maybe allow the setting of color?
