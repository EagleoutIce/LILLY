...
{\input{Lilly_Files/Data/POIs/_LILLY_BOXES_DEFAULT(renew)}\hspace{-3.25em}\begin{minipage}{0.32\linewidth}
    \begin{satz}[Nice]
        Superwichtig
    \end{satz}
\end{minipage}} & {\input{Lilly_Files/Data/POIs/_LILLY_BOXES_ALTERNATE}\hspace{-3.25em}\begin{minipage}{0.32\linewidth}
    \begin{satz}[Nice]
        Superwichtig
    \end{satz}
\end{minipage}} & {\input{Lilly_Files/Data/POIs/_LILLY_BOXES_LIMERENCE}\hspace{-3.25em}\begin{minipage}{0.32\linewidth}
    \begin{satz}[Nice]
        Superwichtig
    \end{satz}
\end{minipage}}
