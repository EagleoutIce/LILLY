...
{\input{Lilly_Files/Data/POIs/_LILLY_BOXES_DEFAULT}\hspace{-3.25em}\begin{minipage}{0.32\linewidth}
    \begin{satz}[Nice]
        Superwichtig
    \end{satz}
...
\end{lstlisting}
\marginpar{\tiny Natürlich wäre es schöner auch andere Verzeichnisse zuzulasen und hierbei dann den gesamten Pfad anzugeben - dies ist aber bisher auch TODO:}Über genau dieses Verfahren lassen sich auch die Box-Designs beliebig erweitern.
