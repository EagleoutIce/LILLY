...
\input{Lilly_Files/Data/Semster/\LILLY@Semester/Definitions/
       \LILLY@Vorlesung}
\end{lstlisting}
...
\begin{description}
    \item[1. Semster] \url{../Lilly/Lilly_Files/Data/Semster/1/Readme.md}
    \item[2. Semster] \url{../Lilly/Lilly_Files/Data/Semster/2/Readme.md}
\end{description}
