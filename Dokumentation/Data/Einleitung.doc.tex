...
So benötigt \T{Mitschrieb} noch den Parameter \T{Vorlesung}, der zusammen mit dem Parameter \T{Semester} gemäß:
\begin{latex*}
...
% \section{Kurzübersicht der neuen Befehle}
% Hier eine Kurzübersicht über alle in Version \LILLYxVERSION hinzugekommenen Befehle
% Make an automated LATERREAD to allow list operations to be stored in an aux file and reread n the second-run
\clearpage
