...
\LILLYxNOTExVersion{2.0.0}Aktuell kommt die Dokumentklasse ohne \T{.ins} oder \T{.dtx} Datei, dafür allerdings mit einem Installer für alle Debian (Linux) basierten Betriebsysteme, an einer Variante für MacOS und Windows wird momentan gearbeitet.
