...
\section{Kurzübersicht: Neues in Version \LILLYxVERSION{}}
...
Hier die in dieser Version veränderten Makros und Umgebungen in der Reihenfolge ihres Erscheinens:
\typesetList[typesetCommandsForList]{\thelChangedCommands}.\newline
Die hier präsentierte Anzeige erfolgt übrigens mithilfe von \blankcmd{typesetList}.
\clearpage
...
\begin{multicols}{2}
    ...
    \end{itemize}
\end{multicols}
Mit \LILLYxBOXxVersion{2.0.0} ist es nötig nur \clatex{Dokumentation} anstelle von \clatex{Typ=Dokumentation} zu schreiben, da die explizite Zuweisung versucht, auf die entsprechende Datei zu referenzieren. Die Definition für dieses Dokument lautet zum Beispiel (für das Argument \T{kpfont} siehe \LILLYxNOTExLibrary{LILLYxFONTS}): % TODO: Change who am i in texts
\begin{latex*}
