...
\begin{multicols}{2}
    ...
    \end{itemize}
\end{multicols}
Mit \LILLYxBOXxVersion{2.0.0} ist es möglich auch nur \clatex{Dokumentation} anstelle von \clatex{Typ=Dokumentation} zu schreiben. Die Definition für dieses Dokument lautet zum Beispiel:
\begin{latex}
