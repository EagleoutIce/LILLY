...
\begin{bemerkung}[Standalone Color]
    Mit \LILLYxBOXxVersion{2.0.0} wurde die Farben-Integration als eigenes Paket (\LILLYxNOTExLibrary{LILLYxCOLOR}) etabliert, welches sich auch eigenständig über \begin{latex}
