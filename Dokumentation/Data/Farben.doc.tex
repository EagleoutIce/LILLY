...
\begin{multicols}{2}
    ...
    \end{itemize}
\end{multicols}
Weiter gibt es noch die Farbe: \CMDshow{LILLYxLINKSxMainColorDarker} (\cs@show{\LILLYxLINKSxMainColorDarker}). Sie wird gemäß: \T{\textbackslash LILLYxLINKSxMainColor!90!black} generiert. \newline
Beispielhaft lässt sich die Definitionsfarbe mit: \CMDshow{LILLYxColorxDefinition} abfragen (\cs@show{\LILLYxColorxDefinition})
...
\begin{multicols}{2}
    ...
    \end{itemize}
\end{multicols}
Die Farbe \CMDshow{LILLYxLINKSxMainColorDarker} (\cs@show{\LILLYxLINKSxMainColorDarker}) wird hier mithilfe von: \T{\textbackslash LILLYxLINKSxMainColor!95!black} generiert.
